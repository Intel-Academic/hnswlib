...
static TestResult
test_approx(unsigned char *massQ, size_t qsize, size_t vecsize, size_t n_queries, HierarchicalNSW<int> &appr_alg,
            size_t vecdim,
...
static void
test_vs_recall(unsigned char *massQ, size_t qsize, size_t vecsize, size_t n_queries, HierarchicalNSW<int> &appr_alg,
               size_t vecdim,
...
#pragma omp critical
        ...
        while (size > 1000) {
            ...
            m.push_back(appr_alg->M_);
        }
        appr_alg->hm_ann_promote(levels, m);
        cout << "Build time:" << 1e-6 * stopw_full.getElapsedTimeMicro() << "  seconds\n";
        cout << "Hops: hier: " << appr_alg->metric_hops_hier << " L0: " << appr_alg->metric_distance_computations_hier
             << endl;
        cout << " Distances: hier: " << appr_alg->metric_distance_computations_hier << " L0: "
             << appr_alg->metric_distance_computations_l0 << endl;
